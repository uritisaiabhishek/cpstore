          ...
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div class="flex border-b-2 border-gray-100 pb-4">
                <span class="title-font font-medium text-2xl text-gray-900">₹5699.00</span>
                ...
                <div class="flex sm:flex-row flex-col px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end  border-b-2 border-gray-100 pb-4 pt-4 ">
                    <div class="relative flex-grow w-full">
                        <button class="w-full text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Add to cart</button>
                    </div>
                    <div class="relative flex-grow w-full">
                        <button class="w-full bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">
                            Buy Now
                        </button>
                    </div>
                </div>
              ...
              <div class="flex border-t border-gray-200 py-2">
                ...
                <span class="ml-auto text-gray-900">Fastrack</span>
              </div>
              <div class="flex border-t border-gray-200 py-2">
                <span class="text-gray-500">Quantity</span>
                <span class="ml-auto text-gray-900">4</span>
              </div>
              <div class="flex border-b border-gray-200"></div>
            </div>
          </div>
        </div>
      </section>